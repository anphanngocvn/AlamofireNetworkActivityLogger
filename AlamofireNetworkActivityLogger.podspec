Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/anphanngocvn/AlamofireNetworkActivityLogger'
  s.social_media_url = 'https://www.linkedin.com/in/konstantinkabanov'
  s.authors = { 'Konstantin Kabanov' => 'fever9@gmail.com' }

  s.source = { :git => 'https://github.com/anphanngocvn/AlamofireNetworkActivityLogger.git', :tag => s.version }
